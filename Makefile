...
output: src/main.o src/Resource.o src/Reservation.o src/ReservationManager.o
	g++ src/main.o src/Resource.o src/Reservation.o src/ReservationManager.o -o output
